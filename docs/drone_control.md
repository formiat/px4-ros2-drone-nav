...
and blackbox projection diagnostics. Stage 1 does not use `z_m` as a vertical
profile follower. Vertical velocity is still generated by the altitude hold
controller against `cruise_altitude_m`.
