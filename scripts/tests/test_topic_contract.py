...
class TopicContractTest(unittest.TestCase):
    ...
    def test_debug_bag_records_raw_memory_and_final_prohibited_grid(self) -> None:
        ...
        self.assertIn("/drone_city_nav/executable_trajectory", text)
        self.assertIn("/drone_city_nav/replan_blocker", text)
        self.assertIn("/drone_city_nav/replan_truncation", text)
