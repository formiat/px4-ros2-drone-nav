...
EXECUTION_FILES = (EXECUTION, EXECUTION_PUBLICATION, EXECUTION_HOLDS, EXECUTION_RETENTION)
...
class InterceptRadarContractTest(unittest.TestCase):
    ...
    def test_attacker_avoidance_preserves_physical_obstacle_safety(self) -> None:
        ...
        self.assertIn("FiniteExecutionPathStatus3D::kRawCollision", finite_execution)
