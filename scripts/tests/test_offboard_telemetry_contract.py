...
OFFBOARD_SOURCES = [
    ...
    REPO_ROOT / "drone_city_nav/src/px4_offboard_node_control_state.cpp",
    ...
    REPO_ROOT / "drone_city_nav/src/px4_offboard_node_trajectory_io.cpp",
    ...
    def test_runtime_configs_expose_attitude_topic(self) -> None:
        for relative_path in ("drone_city_nav/config/urban_mvp.yaml",):
            with self.subTest(relative_path=relative_path):
                ...
                self.assertIn("vertical_setpoint_max_climb_speed_mps: 4.0", text)
                self.assertIn("vertical_setpoint_max_descent_speed_mps: 4.0", text)
                self.assertIn("vertical_setpoint_max_accel_mps2: 3.5", text)
                self.assertIn("vertical_setpoint_max_jerk_mps3: 10.0", text)
