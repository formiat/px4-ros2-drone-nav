...
optional_env_vars=(
  ...
  ENABLE_STATIC_MAP
  EVADER_PX4_LOG_FILE
  EVADER_SIM_START_X_M
  EVADER_SIM_START_YAW_RAD
  EVADER_SIM_START_Y_M
  EVADER_SIM_START_Z_M
  EVADER_SPEED_SCALE
  ...
  INTERCEPTOR_1_SIM_START_X_M
  INTERCEPTOR_1_SIM_START_YAW_RAD
  INTERCEPTOR_1_SIM_START_Y_M
  INTERCEPTOR_1_SIM_START_Z_M
  INTERCEPTOR_2_PX4_LOG_FILE
  INTERCEPTOR_2_SIM_START_X_M
  INTERCEPTOR_2_SIM_START_YAW_RAD
  INTERCEPTOR_2_SIM_START_Y_M
  INTERCEPTOR_2_SIM_START_Z_M
  LIDAR_DEBUG_DIR
  MISSION_CHECK
  MISSION_TYPE
  PX4_AUTOPILOT_DIR
