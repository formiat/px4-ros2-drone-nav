...
[[nodiscard]] CooperativeManeuverCommandData command() {
  return CooperativeManeuverCommandData{
      ...
      .passage_yield_required = false,
      .passage_yield_to_vehicle_id = {},
      .passage_traversal_id = {},
      .passage_conflict_resource_id = {},
      .passage_route_generation = 0U,
      .passage_lateral_offset_m = 0.0,
      .passage_minimum_lateral_offset_m = 0.0,
      .passage_maximum_lateral_offset_m = 0.0,
      .passage_entry_not_before_ns = 0,
      .conflicting_peers =
          {
