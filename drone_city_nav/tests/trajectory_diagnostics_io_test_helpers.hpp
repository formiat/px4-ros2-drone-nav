...
[[nodiscard]] inline TrajectoryPlannerStats populatedStats() {
  ...
  stats.known_passage_validation.diagnostics.push_back(KnownPassageValidationSpan{
      ...
      .valid = false});
  stats.vertical_profile.enabled = true;
  stats.vertical_profile.active = true;
  stats.vertical_profile.applied = true;
  stats.vertical_profile.valid = true;
  stats.vertical_profile.passages_matched = 1U;
  stats.vertical_profile.passages_profiled = 1U;
  stats.vertical_profile.infeasible_count = 0U;
  stats.vertical_profile.min_z_m = 10.5;
  stats.vertical_profile.max_z_m = 18.0;
  stats.vertical_profile.max_abs_dz_ds = 0.18;
  stats.vertical_profile.max_abs_d2z_ds2 = 0.04;
  stats.vertical_profile.max_abs_d3z_ds3 = 0.02;
  stats.vertical_profile.min_vertical_speed_cap_mps = 7.5;
  stats.vertical_profile.diagnostics.push_back(
      VerticalProfilePassageDiagnostic{.structure_id = "arch_01",
                                       .opening_id = "main",
                                       .entry_s_m = 42.5,
                                       .exit_s_m = 48.75,
                                       .approach_start_s_m = 30.0,
                                       .gate_hold_start_s_m = 38.0,
                                       .exit_end_s_m = 62.0,
                                       .gate_z_m = 10.5,
                                       .min_z_m = 8.0,
                                       .max_z_m = 12.0,
