...
[[nodiscard]] RiskAwareLattice3DResult searchRiskAwareLattice3DStage(
    ...
    const Point3& mission_goal, std::span<const ConstrainedFreeSpaceEdge> channel_edges,
    Lattice3DRiskStage stage, Lattice3DTopologyRequirement topology_requirement,
