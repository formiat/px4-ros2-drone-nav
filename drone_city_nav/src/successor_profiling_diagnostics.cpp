...
successorProfilingJsonFields(const LatticeSuccessorProfiling& lattice_2d,
  ...
  output << ",\"successor_search_batches\":" << lattice_2d.search.collection_calls
         ...
         << lattice_2d.continuation.candidates
         ...
         << lattice_2d.continuation.worker_ms
         ...
         << lattice_3d.search.maximum_candidates
