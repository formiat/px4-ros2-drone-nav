...
void writeOffboardBlackboxRecord(std::ostream& stream,
  ...
  stream << ",\"vertical_hard_window_active\":";
  writeBlackboxJsonBool(stream, vertical_plan.vertical_hard_window_active);
  stream << ",\"vertical_safe_min_z_m\":";
  writeBlackboxJsonNumberOrNull(stream, vertical_plan.vertical_safe_min_z_m);
  stream << ",\"vertical_safe_max_z_m\":";
  writeBlackboxJsonNumberOrNull(stream, vertical_plan.vertical_safe_max_z_m);
  stream << ",\"vertical_gate_z_m\":";
  writeBlackboxJsonNumberOrNull(stream, vertical_plan.vertical_gate_z_m);
  stream << ",\"vertical_safe_error_m\":";
  writeBlackboxJsonNumberOrNull(stream, vertical_plan.vertical_safe_error_m);
  stream << ",\"passage_mode\":";
