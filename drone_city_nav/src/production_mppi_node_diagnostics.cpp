...
void ProductionMppiNode::processDiagnostics(
  ...
  line
      ...
      << " planning_exposure_m=" << result.planning_exposure_m << " eligible_available="
      ...
      << " route_directed_candidate_best_eligible="
      << (result.route_directed_candidate_best_eligible ? "true" : "false")
      << " route_directed_candidate_generation="
      << result.route_directed_candidate_generation
      << " temporary_frontier_continuation_ready="
      << (snapshot.temporary_frontier_continuation_ready ? "true" : "false")
      << " no_eligible_phase="
      << mppiNoEligiblePhaseName(snapshot.no_eligible_recovery.phase)
