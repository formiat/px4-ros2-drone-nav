...
PlannerNode::PlannerNode()
  ...
  RCLCPP_INFO(get_logger(),
              ...
              known_passage_validation_config_.min_opening_depth_fraction,
...
void PlannerNode::applyConfig(const PlannerNodeConfig& config) {
  ...
  memory_snapshot_diagnostic_period_s_ =
  ...
  no_static_tracking_error_margin_m_ = config.no_static_rollout.tracking_error_margin_m;
  ...
  known_static_opening_boundary_tolerance_m_ =
      config.known_static_opening_boundary_tolerance_m;
