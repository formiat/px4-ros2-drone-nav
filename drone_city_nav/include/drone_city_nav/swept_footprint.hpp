...
// no closer to it than the seed, again within the tolerance: departing from
// the contact stays valid, any further approach collides, and evidence the
// body does not overlap at the seed is never exempt.
