...
struct TrajectoryOptimizerStats {
  ...
  std::size_t active_window_centerline_blocked{0U};
  std::size_t active_window_heading_change_samples{0U};
  std::size_t active_window_heading_span_samples{0U};
  ...
  std::size_t centerline_blocked_span_count{0U};
  std::size_t centerline_blocked_first_segment_index{0U};
  std::size_t centerline_blocked_last_segment_index{0U};
  double centerline_blocked_first_s_m{std::numeric_limits<double>::quiet_NaN()};
  double centerline_blocked_last_s_m{std::numeric_limits<double>::quiet_NaN()};
  double centerline_blocked_span_length_m{std::numeric_limits<double>::quiet_NaN()};
  double centerline_blocked_first_x_m{std::numeric_limits<double>::quiet_NaN()};
  double centerline_blocked_first_y_m{std::numeric_limits<double>::quiet_NaN()};
  double centerline_blocked_last_x_m{std::numeric_limits<double>::quiet_NaN()};
