...
// suppresses it and constrains nothing about where the body then moves.
//
...
// The same seed against one observed world, whose voxel size sets the contact
// tolerance. Returns no seed without an observed world: a static world is not
// evidence the vehicle observed from where it stands.
