...
enum class CompiledTrajectoryFailureReason3D : std::uint8_t {
  ...
  kMissingTrackingWorld,
  kInvalidTrackingErrorTubeRoute,
  kInvalidTrackingErrorTubeWorld,
  kInvalidTrackingErrorTubeContract,
  kInvalidTrackingErrorTubeSegment,
  kInvalidTrackingErrorTubeProfile,
  kInvalidTimeProfile,
